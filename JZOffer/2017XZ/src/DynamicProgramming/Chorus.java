...
/**
 * 有 n 个学生站成一排，每个学生有一个能力值，牛牛想从这 n 个学生中按照顺序选取 k 名学生，要求相邻两个学生的位置编号的差
 * 不超过 d，使得这 k 个学生的能力值的乘积最大，你能返回最大的乘积吗？
 * <p>
 * 输入描述:
...
public class Chorus {
    /**
     * 1. 题目分析
     * 题目要求n各学生中选择k个，使这k个学生的能力值乘积最大。这是一个最优化的问题。另外，在优化过程中，提出了相邻两个学
     * 生的位置编号差不超过d的约束。
     ...
     * <p>
     * 3.编程实现
     * 遍历。因为一般看解答的多半是自己遇到问题不大会的，所以程序里面有写注释。如果大家不懂可以再问我，我回复或者再把解答
     * 写详细点。欢迎讨论。
     *
     * @param args
     */
