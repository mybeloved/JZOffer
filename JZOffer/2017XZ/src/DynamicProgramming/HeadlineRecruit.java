...
/**
 * @program: JZOffer
 * @description: 头条的2017校招开始了！为了这次校招，我们组织了一个规模宏大的出题团队，
 * 每个出题人都出了一些有趣的题目，而我们现在想把这些题目组合成若干场考试出来，在选题之前，我们对题目进行了盲审，
 * 并定出了每道题的难度系统。一场考试包含3道开放性题目，假设他们的难度从小到大分别为a,b,c，
 ...
 * 2
 * @author: whx
 * @create: 2018-10-06 11:13
 **/
public class HeadlineRecruit {
